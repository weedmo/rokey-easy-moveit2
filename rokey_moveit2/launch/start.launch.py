...
def rviz_node_function(context):
    ...
    package_name_str = "rokey_moveit2"
    ...
    rviz_base = os.path.join(
        get_package_share_directory(package_name_str), "config"
    )
...
def generate_launch_description():
    ...
    rokey_arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        namespace=LaunchConfiguration('name'),
        arguments=[
            "rokey_arm_controller",
            "-c",
            "controller_manager",
        ],
    )
    rokey_hand_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        namespace=LaunchConfiguration('name'),
        arguments=[
            "rokey_hand_controller",
            "-c",
            "controller_manager",
        ],
    )
    ...
    nodes = [
        ...
        rokey_arm_controller_spawner,
        rokey_hand_controller_spawner,
        control_node,
    ]
